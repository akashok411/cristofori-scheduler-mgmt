...
const errorTypes = require('../models/error-types-model');
const logService = require('../services/log-service');

module.exports = function errorHandlerFactory() {
    const writeError = logService.getErrorLogger('errorHandler');
    return (err, req, res, next) => {
        ...
        if (res.headersSent) {
            ...
            res.status(401).json({ message: 'The username or password was invalid.', });
